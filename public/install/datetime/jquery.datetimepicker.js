                        ...
                        function (event) {
                            ...
                            if (
                                ...
                                if (options.ownerDocument) {
                                    $(options.ownerDocument.body).addClass(
                                        "xdsoft_noselect"
                                    );
                                }
                                $([
                                    options.ownerDocument.body,
                    ...
                    .on(
                        ...
                        function (event, percentage) {
                            ...
                            timeboxTop = parseFloat(
                                Math.abs(
                                    (timebox[0].offsetHeight - parentHeight) *
                                        percentage
                                ).toFixed(4)
                            );
        ...
        createDateTimePicker = function (input) {
            ...
            var handleTouchMoved = function (event) {
                ...
                var distance = Math.sqrt(
                    xMovement * xMovement + yMovement * yMovement
                );
            ...
            month_picker
                ...
                .on("touchstart mousedown.xdsoft", function (event) {
                    ...
                    this.touchStartPosition = evt.touches
                        ? evt.touches[0]
                        : evt;
                    event.stopPropagation();
                    event.preventDefault();
                ...
                .on("xchange.xdsoft", function (event) {
                    ...
                    xchangeTimer = setTimeout(function () {
                        ...
                        if (options.minDateTime !== false) {
                            minDateTime = _xdsoft_datetime.strToDate(
                                options.minDateTime
                            );
                        ...
                        if (options.maxDateTime !== false) {
                            maxDateTime = _xdsoft_datetime.strToDate(
                                options.maxDateTime
                            );
                        ...
                        if (options.minDateTime !== false) {
                            var t = _xdsoft_datetime.strToDateTime(
                                options.minDateTime
                            );
            ...
            datetimepicker
                ...
                .on("generate.xdsoft", function () {
                    if (
                        options.onGenerate &&
                        typeof options.onGenerate === "function"
                    ) {
            ...
            setPos = function () {
                ...
                datetimepickerCss = {
                    position: position,
                    left: options.insideParent
                        ? dateInputElem.offsetLeft
                        : left,
                ...
                if (typeof options.mask === "string") {
                    ...
                    input.on("keydown.xdsoft", function (event) {
                        ...
                        if (
                            ...
                            while (true) {
                                var maskValueAtCurPos = options.mask.slice(
                                    pos,
                                    pos + 1
                                );
                                var posShorterThanMaskLength =
                                    pos < options.mask.length;
                                var posGreaterThanZero = pos > 0;
                                var notNumberOrPlaceholder = /[^0-9_]/;
                                var curPosOnSep =
                                    notNumberOrPlaceholder.test(
                                        maskValueAtCurPos
                                    );
                                var continueMovingPosition =
                                    curPosOnSep &&
                                    posShorterThanMaskLength &&
                                    posGreaterThanZero;
                            ...
                            if (hasSel) {
                                ...
                                var defaultBlank = options.mask.replace(
                                    /[0-9]/g,
                                    "_"
                                );
                                var defaultBlankSelectionReplacement =
                                    defaultBlank.slice(pos, pos + selLength);
                                var selReplacementRemainder =
                                    defaultBlankSelectionReplacement.slice(1); // might be empty

                                var valueBeforeSel = val.slice(0, pos);
                                var insertChars =
                                    digit + selReplacementRemainder;
                                var charsAfterSelection = val.slice(
                                    pos + selLength
                                );
